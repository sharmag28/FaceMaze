...
import sys
sys.path.insert(0,'C:/Users/Gautam/Desktop/Images/keras-face-master')
from resize import *
...
def main():
    ...
    model_dir_path = 'C:/Users/Gautam/Desktop/Images/keras-face-master/demo/models'
    image_dir_path = "C:/Users/Gautam/Desktop/Images/Gautam"
    ...
    database = dict()
    database["Gautam"] = [fnet.img_to_encoding(image_dir_path+"/IMG_20180221_202446.jpg")]
    #database["Apurva"] = 

    
    
    img_resizer("IMG_20180223_023147.jpg")
    img_resizer("IMG_20180221_202431.jpg")
    
    fnet.verify(image_dir_path + "/IMG_20180223_023147.jpg", "Gautam", database)
    
    fnet.who_is_it(image_dir_path + "/IMG_20180221_202431.jpg", database)
